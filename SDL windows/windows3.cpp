...
bool loadMedia()
{
	...
	//Load prompt texture
	if( !gPromptTexture.loadFromFile( "music/prompt.png" ) )
	{
	...
	//Load sound effects
	gScratch = Mix_LoadMUS( "music/_Sparkle.wav" );
	if( gScratch == NULL )
	{
				...
				while( SDL_PollEvent( &e ) != 0 )
				{
					...
					else if( e.type == SDL_KEYDOWN )
					{
						switch( e.key.keysym.sym )
						{
							...
							case SDLK_2:
							Mix_PlayChannel( 2, gMedium, 0 );
							break;
							
							//Play low sound effect
							case SDLK_3:
							Mix_PlayChannel( -1, gLow, 3 );
							break;
							
							//Play scratch sound effect
							case SDLK_4:
							Mix_PlayMusic( gScratch, -1);
							break;
